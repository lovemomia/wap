...
public class TestController {
    ...
    private List<Test> getTests() {
        String sql = "SELECT A.Id, A.Title, A.Cover, COUNT(DISTINCT B.UserId) AS Joined FROM SG_Test A LEFT JOIN SG_TestResult B ON A.Id=B.TestId WHERE A.Status<>0 GROUP BY A.Id";
