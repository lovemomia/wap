...
public class CourseController extends AbstractController {
    ...
    public ModelAndView cancelable(@RequestParam long id, @RequestParam String address, @RequestParam String scheduler) {
    ...
    public ModelAndView skuplace(@RequestParam long id,
        ...
        switch (status) {
            case SKU_PLACE_STATUS_CURRENT_MONTH:
                resp = get("/course/sku/month?id=" + id + "&month=" + month);
                break;
            case SKU_PLACE_STATUS_NEXT_MONTH:
                resp = get("/course/sku/month?id=" + id + "&month=" + nextMonth);
                break;
            default:
                resp = get("/course/sku/week?id=" + id);
        }
